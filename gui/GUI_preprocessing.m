...
function GUI_preprocessing_OpeningFcn(hObject, eventdata, handles, varargin)
    ...
    handles.detectStimulationGaps_checkbox = uicontrol( ...
        ...
        'Value', 0, ...
        'Units', 'normalized', ...
        'Position', [refPos(1) refPos(2)-0.02 refPos(3), refPos(4)], ...
...
%     handles.output = hObject;   
    ...
    handles.dataInspection_group    = {handles.text_dataInspection, ...
                                       handles.timeRange_edit,...
                                       handles.text_dataInspection2,...
                                       handles.text_dataInspection3, ...
                                       handles.amplitude_edit, ...
                                       handles.text_dataInspection4, ...
                                       handles.removeChannels_checkbox, ...
                                       handles.detectStimulationGaps_checkbox};
    ...
    handles.artifactsRejection_group= {handles.text_artifRejection, handles.lowAmplitudeThreshold_edit, ...
                                       handles.highAmplitudeThreshold_edit, handles.text_artifRejection2, ...
                                       handles.text_artifRejection3, handles.minTimeWindowArtifacts_edit,...
                                       handles.maxTimeWindowArtifacts_edit , handles.text_artifRejection4,...
                                       handles.text_artifRejection5, handles.sampleToSample_edit ,...
                                       handles.text_artifRejection6, handles.text_artifRejection7, ...
                                       handles.noActivity_edit, handles.text_artifRejection8, ...
                                       handles.text_artifRejection9 ,handles.noActivityDuration_edit, ...
                                       handles.text_artifRejection10, handles.use_previously_rejected_epochs_checkbox };
